// from
// https://github.com/dmikushin/stdcapture/blob/master/include/stdcapture/stdcapture.h
...
public:
  ...
  ~CaptureOutput() {
    ...
    do {
      ...
      fd_blocked = false;
#ifdef _MSC_VER
      if (!eof(pipes[READ])) bytesRead = read(pipes[READ], buf, bufSize - 1);
#else
